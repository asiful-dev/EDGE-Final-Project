      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-10">
            ...
            <div className="absolute bottom-20 left-1/4 text-5xl animate-bounce delay-1000">
              😆
            </div>
            <div className="absolute bottom-10 right-1/3 text-3xl animate-pulse delay-500">
              😄
            </div>
          </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-gray-200 max-w-4xl mx-auto">
                <p className="text-xl text-gray-700 leading-relaxed mb-6">
                  ...
                  that'll make you smile instantly, or you're feeling
                  adventurous and want a{" "}
            ...
            <div className="group bg-white rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 border border-gray-200 overflow-hidden transform hover:-translate-y-2 max-w-4xl mx-auto">
              ...
              <div className="p-10">
                <div className="flex items-start space-x-4 mb-8">
                  ...
                  <div className="text-4xl animate-bounce">{randomEmoji}</div>
                </div>
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-200">
                  <div className="flex space-x-4">
                    ...
                    >
                      <svg
                        className={`w-5 h-5 ${
                          isFavorite ? "fill-pink-500" : "fill-none"
                        }`}
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                  ...
                  <div className="text-xs text-gray-400">ID: {joke.id}</div>
                </div>
              </div>
            </div>
          )}
